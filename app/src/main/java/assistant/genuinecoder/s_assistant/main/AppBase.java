...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("S1 ANDROID STUDIO");
        divisions.add("S2 WEB API");
        divisions.add("S3 PERVASIVE COMPUTING");
        divisions.add("S4 JAVA");
        divisions.add("S5 COMPUTER SYSTEM");
        divisions.add("S6 AGILE DEVELOPMENT");
        divisions.add("S7 NETWORKING");
